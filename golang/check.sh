#!/usr/bin/env bash
#
# This script refs from https://github.com/google/trillian/blob/master/scripts/presubmit.sh.

set -eu

# check whether all dependent tools exist
check_deps() {
  local failed=0
